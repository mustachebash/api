...
export default async () => {
	const PinoPrettyModule = (await import('pino-pretty')).default,
		chalk = (await import('chalk')).default,
		// I'm not fully sure why this is required to appease TS, but the default is a circular reference to itself which makes the types work, but the function is callable regardless
		pretty = PinoPrettyModule.default;
