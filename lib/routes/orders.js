const Router = require('@koa/router'),
	...
	{ getOrderTickets } = require('../services/guests'),
...
ordersRouter
	...
	.post('/', async ctx => {
		...
		try {
			...
			sendReceipt(firstName, lastName, email, transaction.processor_transaction_id, orderToken, order.amount);
			...
			ctx.status = 201;
			return ctx.body = {confirmationId: transaction.processor_transaction_id, token: orderToken};
		} catch(e) {
...
// TODO: change this access to get all current `customer` orders?
