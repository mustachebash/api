...
transactionsRouter
	...
	.delete('/:id', authorizeUser, async (req, res, next) => {
		try {
...
transactionsRouter
	.get('/:id/processor-details', authorizeUser, async (req, res, next) => {
		try {
...
transactionsRouter
	.get('/:id/tickets', authorizeUser, async (req, res, next) => {
		try {
...
transactionsRouter
	.get('/:id/token', authorizeUser, async (req, res, next) => {
		try {
