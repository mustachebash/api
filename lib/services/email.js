...
module.exports = {
	...
	sendReceipt(guestFirstName, guestLastName, guestEmail, confirmation, transactionToken, amount) {
		mailgun.messages().send({
			...
			subject: 'Mustache Bash SF 2023 - Your Ticket Order - Confirmation ' + confirmation,
			html: `
<!doctype html>
<html>
  <head>
    ...
    <title>The Mustache Bash SF Confirmation</title>
    <style>
  ...
  <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
      ...
      <tr>
        ...
        <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; max-width: 580px; padding: 10px; width: 580px; margin: 0 auto;" width="580" valign="top">
          <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 580px; padding: 10px;">
            ...
            <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">The Mustache Bash San Francisco - Confirmation #${confirmation}. Thanks so much for your ticket order!</span>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                        <td class="align-center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; text-align: center;" valign="top" align="center">
                            <img src="https://mustachebash.com/img/fro-man.png" alt="The Mustache Bash" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;">
                        </td>
                    </tr>
                    <tr>
                        <td class="align-center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; text-align: center;" valign="top" align="center">
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We're excited to have you at the 2023 San Francisco Mustache Bash! Keep this confirmation email for your records. Be sure to bring your tickets linked above and a photo ID for each guest to get in. Do not forward this email or share your tickets link with anyone.</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">If you purchased a hotel room, you will be able to check in with the confirmation number above.</p>
	...
	sendTransfereeConfirmation(transfereeFirstName, transfereeLastName, transfereeEmail, originalTransactionId, transactionToken) {
		mailgun.messages().send({
			...
			subject: 'Mustache Bash SF 2023 - Your Tickets - Transfer Confirmation ' + originalTransactionId.substring(0, 8),
			html: `
<!doctype html>
<html>
  <head>
