...
module.exports = {
	...
	sendReceipt(guestFirstName, guestLastName, guestEmail, confirmation, transactionToken, amount) {
		mailgun.messages().send({
			...
			subject: 'Mustache Bash 2023 - Your Ticket Order - Confirmation ' + confirmation,
			html: `
<!doctype html>
<html>
  <head>
  ...
  <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We're excited to have you at the 2023 Mustache Bash! Keep this confirmation email for your records. Be sure to bring your tickets and a photo ID for each guest to get in and pick up your wristband at willcall. Do not forward this email or share your tickets link with anyone.</p>
	...
	sendTransfereeConfirmation(transfereeFirstName, transfereeLastName, transfereeEmail, originalTransactionId, transactionToken) {
		mailgun.messages().send({
			...
			subject: 'Mustache Bash 2023 - Your Tickets - Transfer Confirmation ' + originalTransactionId.substring(0, 8),
			html: `
<!doctype html>
<html>
  <head>
