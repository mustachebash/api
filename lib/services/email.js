...
module.exports = {
	...
	sendReceipt(guestFirstName, guestLastName, guestEmail, confirmation, amount) {
		mailgun.messages().send({
			...
			subject: 'Mustache Bash 2019 - Your Ticket Order - Confirmation ' + confirmation,
			html: `
<!doctype html>
<html>
  <head>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                        <td class="align-center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; text-align: center;" valign="top" align="center">
                            <img src="https://mustachebash.com/img/fro-man-salmon.png" alt="The Mustache Bash" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;">
                        </td>
                    </tr>
                    <tr>
                        <td class="align-center" style="font-family: sans-serif; font-size: 14px; vertical-align: top; text-align: center;" valign="top" align="center">
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We're excited to have you at the 2019 Mustache Bash! Keep this confirmation email for your records. We have your name on the list, so be sure to bring your photo ID to get in and pick up your wristband at willcall. If you bought multiple tickets for others, arrive together or share this confirmation number with them so they can check in without you.</p>
