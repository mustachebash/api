...
module.exports = {
	 ...
	 *   so those will not be duplicated and attached to a transfer (the transferee did not "order" "products" from us, they were granted the result of the product, "guests")
	 ...
	 * - The transferee will be upserted into customers, which means the original customer will need ot input first/last/email
	 */
	async transferTickets(orderId, { transferee, guestIds }) {
