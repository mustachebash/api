...
// Put information in here that won't be present in StackDriver's metadata about a request
...
// Some of this is redundant to the reqSerializer, but it's needed for StackDriver metadata
				...
				stream: bunyanDebugStream({
					...
					stringifiers: {
						req: ({ method, url, body }, { entry }) => {
							...
							return {
								value: `${method} ${url} ${res.status} ${body || ''}`,
								consumed: ['req']
							};
						},
