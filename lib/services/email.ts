...
export function sendCompReceipt(guestFirstName: string, guestLastName: string, guestEmail: string, orderToken: string) {
	mailgun
		.messages()
		.send({
			from: 'Mustache Bash Tickets <contact@mustachebash.com>',
...
.ExternalClass div {
	...
	<body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
							...
							<tr>
								<td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;" valign="top">
									<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
										...
										<tr>
											<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
												<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi ${guestFirstName}! You've received a complimentary ticket to the Mustache Bash. See details below!</p>
												<p style="font-family: sans-serif; font-size: 24px; font-weight: normal; margin: 0; margin-bottom: 15px;">
														<strong><a style="color: #0e2245;" href="https://mustachebash.com/my-tickets?t=${orderToken}">VIEW TICKETS</a></strong>
												</p>
		...
		.then(mailgunResponse => log.info({ mailgunResponse, guestEmail }, 'Comp receipt email sent'))
		.catch(err => log.error({ err, guestEmail }, 'Comp receipt email failed to send'));
}
