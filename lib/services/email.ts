...
export function sendReminderEmail(customerFirstName: string, customerLastName: string, customerEmail: string, orderToken: string) {
	mailgun.messages().send({
		from: 'Mustache Bash Tickets <contact@mustachebash.com>',
		to: customerFirstName + ' ' + customerLastName + ' <' + 'furfaro.joe@gmail.com' + '> ',
		subject: 'San Diego Mustache Bash 2024 is Almost Here!',
		html: `
<!doctype html>
<html>
  <head>
  ...
  <body class="" style="background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;" width="100%" bgcolor="#f6f6f6">
      <tr>
              ...
              <tr>
                <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;" valign="top">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi ${customerFirstName}! The Bash is right around the corner, so here's a few reminders.</p>
						<p style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            <strong><a style="color: #0e2245;" href="https://mustachebash.com/mytickets?t=${orderToken}">VIEW YOUR TICKETS HERE</a></strong>
                        </p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">On Bash day, bring your tickets linked above (note: printouts and screenshots WILL NOT be accepted) along with a valid photo ID for each guest to get in. Do not forward this email or ticket link to anyone.</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Check out our <a href="https://mustachebash.com/info?utm_source=confirmation-email">FAQ page</a> for basic Bash rules and what to expect, or email us at <a href="mailto:contact@mustachebash.com">contact@mustachebash.com</a> if you have questions not found on the website.</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">We can’t wait to boogie with you!</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            Stay Funky,<br>
        				    Team Mustache Bash
                        </p>
		...
		.then(mailgunResponse => log.info({mailgunResponse, customerEmail, orderToken}, 'Reminder email sent'))
		.catch(err => log.error({err, customerEmail, orderToken}, 'Reminder email failed to send'));
}
/* eslint-enable */
