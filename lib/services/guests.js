...
module.exports = {
	async createGuest({ firstName, lastName, notes, transactionId = 'COMPED', confirmationId = 'COMPED', createdBy = 'purchase', eventId, vip }) {
	...
	async updateGuest(id, updates) {
		for(const u in updates) {
			// Update whitelist
			if(!['checkedIn', 'firstName', 'lastName', 'updatedBy', 'notes', 'vip'].includes(u)) throw new GuestsServiceError('Invalid guest data', 'INVALID');
		}
